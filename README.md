## rcdiscover (foxy) - 1.1.6-1

The packages in the `rcdiscover` repository were released into the `foxy` distro by running `/usr/bin/bloom-release rcdiscover --rosdistro foxy` on `Tue, 14 Mar 2023 12:38:29 -0000`
...
## rcdiscover (noetic) - 1.1.6-1

The packages in the `rcdiscover` repository were released into the `noetic` distro by running `/usr/bin/bloom-release rcdiscover --rosdistro noetic` on `Tue, 14 Mar 2023 12:33:24 -0000`
...
The packages in the `rcdiscover` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic --new-track rcdiscover` on `Sun, 22 Mar 2020 17:12:40 -0000`
